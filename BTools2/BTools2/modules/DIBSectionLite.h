...
public:
    ...
    static HPALETTE CreateHalftonePalette(CPalette& palette, int nNumColors);
#endif // DIBSECTION_NO_PALETTE
...
public:
	...
	void Create32Bit(CDC *pDC, CDIBSectionLite &dib, int iWidth, int iHeight);
	void Create32Bit(CDIBSectionLite &dib, int iWidth, int iHeight);
	inline COLORREF FixColorRef(COLORREF clr);
