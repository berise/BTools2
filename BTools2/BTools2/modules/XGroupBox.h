...
//=============================================================================
class CXGroupBox : public CWindowImpl<CXGroupBox>//, CStatic>
//=============================================================================
{
public:
...
public:
	// message map
	BEGIN_MSG_MAP(CXGroupBox)
		MSG_WM_CREATE(OnCreate)
		MSG_WM_PAINT(OnPaint)
		MSG_WM_ERASEBKGND(OnEraseBkgnd)	//BOOL OnEraseBkgnd(CDCHandle dc)
		//CHAIN_MSG_MAP(CWindowImpl<CXGroupBox,CStatic>)
	END_MSG_MAP()
...
protected:
	...
	BOOL OnEraseBkgnd(CDCHandle pDC);
