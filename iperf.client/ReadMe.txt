========================================================================
     Microsoft Foundation Class Library for Windows CE: iperf
========================================================================


AppWizard has created this iperf application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your iperf application.

iperf.h
    This is the main header file for the application.  It includes other
    project specific headers (including Resource.h) and declares the
    CIperfApp application class.
...
res\iperf.ico
    ...
    icon is included by the main resource file iperf.rc.
...
iperfDoc.h, iperfDoc.cpp - the document
    These files contain your CIperfDoc class.  Edit these files to
    add your special document data and to implement file saving and loading
    (via CIperfDoc::Serialize).

iperfView.h, iperfView.cpp - the view of the document
    These files contain your CIperfView class.
    CIperfView objects are used to view CIperfDoc objects.
...
StdAfx.h, StdAfx.cpp
    ...
    named iperf.pch and a precompiled types file named StdAfx.obj.
